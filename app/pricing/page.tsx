...
export default function PricingPage() {
  return <main className="pricing-page">
    ...
    <section className="pricing-layout page-width" aria-label="Plans">
      ...
      <article className="plan-panel plan-pro"><div className="plan-recommended"><ShieldCheck />BEST VALUE</div><div><ProBadge label="PRO PLAN" /><h2>$30 <small>/ year</small></h2><p>Or $5 monthly. For commissioners managing the full season.</p></div><PricingActions /></article>
    </section>
